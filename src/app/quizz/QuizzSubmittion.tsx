...
import { balloons, useReward } from "react-rewards";
...
const QuizzSubmittion = (props: Props) => {
      ...
      <main className="py-11 flex flex-col gap-4 items-center flex-1 mt-24">
        ...
        { scorePercentage === 100 ? 
            <div className="flex flex-col items-center">
                <p className="text-2xl text-primary uppercase">🎉 Congratulations! 🎉</p>
...
export default QuizzSubmittion;
